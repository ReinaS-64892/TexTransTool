...
namespace net.rs64.PSD.parser
{
    ...
    {
        public static uint ReadByteToUInt32(this Stream stream) => BitConverter.ToUInt32(ConvertLittleEndian(ReadBytes(stream, 4)), 0);
        ...
        public static bool Signature(Stream stream, byte[] signature)
        {
            ...
            return ReadBytes(stream, 4).SequenceEqual(signature);
