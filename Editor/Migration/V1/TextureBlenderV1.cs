...
namespace net.rs64.TexTransTool.Migration.V1
{
    ...
    internal static class TextureBlenderV1
    {
        ...
        public static void MigrationV1ToV2(TextureBlender textureBlender)
        {
            ...
            var convertBlendTypeKey = textureBlender.BlendType == TexTransUnityCore.BlendTexture.BlendType.AlphaLerp ? TextureBlend.BL_KEY_DEFAULT : textureBlender.BlendType.ToString();
