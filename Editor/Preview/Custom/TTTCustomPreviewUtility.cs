...
namespace net.rs64.TexTransTool.Preview.Custom
{
    ...
    {
        void Preview(TexTransMonoBase texTransBehavior, RenderersDomain editorCallDomain);
    }
    internal static class TTTCustomPreviewUtility
    {
        ...
        internal static bool TryExecutePreview(TexTransMonoBase texTransBehavior, RenderersDomain editorCallDomain)//trueだったらカスタムプレビューしたよってこと、そうでなければカスタムプレビューはないってこと。
        {
