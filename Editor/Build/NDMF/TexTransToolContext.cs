...
namespace net.rs64.TexTransTool.Build.NDMF
{
    internal class TexTransToolContext : IExtensionContext
    {
        ...
        public void OnActivate(BuildContext context)
        {
            if (context != null)
            {
                TTTBuildContext = new TexTransBuildSession(new AvatarDomain(context.AvatarRootObject, false, new AssetSaver(context.AssetContainer), null, TTTConfig.isObjectReplaceInvoke, TTTConfig.UseImmediateTextureStack));
            }
        }
