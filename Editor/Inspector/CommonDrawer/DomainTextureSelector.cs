...
namespace net.rs64.TexTransTool.Editor
{
    internal class DomainTextureSelector : EditorWindow
    {
        ...
        private void initialize(SerializedProperty textureProperty, Component component)
        {
            ...
            .SelectMany(i => i.sharedMaterials).SelectMany(i => i.GetTextureReferences<Texture2D>()).GroupBy(i => i.Key).ToDictionary(i => i.Key, i => i.Select(k => k.Value).Distinct().ToList());
