...
{
    [Serializable]
    public class TextureCompressionData : ITexTransToolTextureFormat
    {
       ...
       public void CopyFrom(TextureCompressionData data)
        {
            FormatQualityValue = data.FormatQualityValue;
            UseOverride = data.UseOverride;
            OverrideTextureFormat = data.OverrideTextureFormat;
