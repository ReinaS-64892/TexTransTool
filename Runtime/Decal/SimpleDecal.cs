    ...
    public sealed class SimpleDecal : TexTransRuntimeBehavior
    {
        ...
        internal Dictionary<Texture, TTRenderTexWithDistance> CompileDecal(IDomain domain)
        {
            ...
            try
            {
                ...
                var decalContext = new DecalContext<ParallelProjectionSpace, ITrianglesFilter<ParallelProjectionSpace>>(ttce, GetSpaceConverter(), GetTriangleFilter(domain));
        ...
        internal ITrianglesFilter<ParallelProjectionSpace> GetTriangleFilter(IDomain domain)
        {
